...
namespace FL1.Controls
{
    ...
    {
        public TelephoneState TelephoneState
        {
            get { return (TelephoneState)GetValue(TelephoneStateProperty); }
            set { SetValue(TelephoneStateProperty, value); }
        }

        public static readonly DependencyProperty TelephoneStateProperty =
            DependencyProperty.Register("TelephoneState", typeof(TelephoneState), typeof(SquareButton), new PropertyMetadata(TelephoneState.Available, telephoneStateChanged));
        ...
        public static readonly DependencyProperty BevelWidthProperty =
            DependencyProperty.Register("BevelWidth", typeof(double), typeof(SquareButton), new PropertyMetadata(10.0));
        ...
        public static readonly DependencyProperty BevelHeightProperty =
            DependencyProperty.Register("BevelHeight", typeof(double), typeof(SquareButton), new PropertyMetadata(10.0));
        ...
        public static readonly DependencyProperty BaseColorProperty =
            DependencyProperty.Register("BaseColor", typeof(Color), typeof(SquareButton), new PropertyMetadata(Colors.PaleTurquoise, new PropertyChangedCallback(colorChanged)));
        ...
        internal static readonly DependencyPropertyKey TopGradientProperty = DependencyProperty.RegisterReadOnly("TopGradient", typeof(LinearGradientBrush), typeof(SquareButton), new PropertyMetadata(new LinearGradientBrush()));
        internal static readonly DependencyPropertyKey LeftGradientProperty = DependencyProperty.RegisterReadOnly("LeftGradient", typeof(LinearGradientBrush), typeof(SquareButton), new PropertyMetadata(new LinearGradientBrush()));
        internal static readonly DependencyPropertyKey BottomGradientProperty = DependencyProperty.RegisterReadOnly("BottomGradient", typeof(LinearGradientBrush), typeof(SquareButton), new PropertyMetadata(new LinearGradientBrush()));
        internal static readonly DependencyPropertyKey RightGradientProperty = DependencyProperty.RegisterReadOnly("RightGradient", typeof(LinearGradientBrush), typeof(SquareButton), new PropertyMetadata(new LinearGradientBrush()));
        internal static readonly DependencyPropertyKey CenterGradientProperty = DependencyProperty.RegisterReadOnly("CenterGradient", typeof(RadialGradientBrush), typeof(SquareButton), new PropertyMetadata(new RadialGradientBrush()));
        ...
        internal static readonly DependencyPropertyKey isLandscapeProperty = DependencyProperty.RegisterReadOnly("isLandscape", typeof(bool), typeof(SquareButton), new PropertyMetadata(true));
